...
#create then repeatable code lock (called a function)
...
streamlit.header("View Ours Fruit List - Add Your Favorites!")
#Snowflake-related funcionts
...
def insert_row_snoeflacke(new_fruit):
	with my_cnx.cursor() as my_cur: 
...
if streamlit.button('Add a Fruit to the list'):
	my_cnx = snowflake.connector.connect(**streamlit.secrets["snowflake"])
	back_from_function = insert_row_snoeflacke(add_my_fruit)
	my_cnx.close()
